...
def run_migrations(request):
    """Temporary endpoint to apply pending migrations on production.

    Protected by a secret token in the URL (no session/cookie needed).
    REMOVE THIS VIEW after migrations are applied.
    """
    import os
